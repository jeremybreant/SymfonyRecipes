 ...
 */
final class Version20230622134419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP people_required, CHANGE food_quantity food_quantity INT NOT NULL, CHANGE food_quantity_type food_quantity_type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD people_required INT DEFAULT NULL, CHANGE food_quantity food_quantity VARCHAR(255) DEFAULT NULL, CHANGE food_quantity_type food_quantity_type VARCHAR(255) DEFAULT NULL');
    }
}
