 ...
 */
final class Version20230516081704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient ADD id INT AUTO_INCREMENT NOT NULL, ADD quantity DOUBLE PRECISION NOT NULL, ADD unit_type VARCHAR(10) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient DROP id, DROP quantity, DROP unit_type');
