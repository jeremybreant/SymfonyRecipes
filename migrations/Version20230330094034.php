 ...
 */
final class Version20230330094034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD is_favorite TINYINT(1) NOT NULL, CHANGE difficulty difficulty INT DEFAULT NULL, CHANGE description description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP is_favorite, CHANGE difficulty difficulty DOUBLE PRECISION DEFAULT NULL, CHANGE description description VARCHAR(255) NOT NULL');
    }
}
